...
## 5. Почему Tensorus v1 как база

> Снято решением ADR-7: хранилище — LanceDB, файл рядом с
> конфигом, а не сервер, который надо поднимать. Рассуждение ниже
> сохранено, потому что Context ADR-7 отвечает на него по пунктам.
> данных
